...
#+begin_src xml
<samplingRateChangeTimes spec="feast.parameter.RealParameterFromRealVector">
...
*** Operators on IntegerParameters
:PROPERTIES:
:CUSTOM_ID: id-3-Operators-on-IntegerParameters
:END:
...
of elements of a single ~IntegerParameter~.  The new operators are:
...
*** Randomly initializing RealParameter values
:PROPERTIES:
:CUSTOM_ID: id-3-Randomly-initializing-RealParameter-values
:END:
...
way, ~RandomRealParameter~ allows you to sample new initial parameter
