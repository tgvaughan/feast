...
MCMC. An initializer for trees, capable of generating a new starting tree at each
attempt is implemented in BEAST. ~RandomRealParameter~ allows you to sample new
